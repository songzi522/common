...
public class HnFileUtils {
    ...
    public static String getCachePath() {
        File f = HnUiUtils.getContext().getCacheDir();
        if (null == f) {
            return null;
        } else {
     ...
     *
     * @param //data   cookie数据
     * @param filePath 保存的路径(/data/dat/包名/chche)
     */
    //    public static void writeFileList(List<Cookie> data, File filePath) {
    //
    //        FileWriter fiw = null;
    ...
    //            }
    //            fiw = new FileWriter(filePath + "/cookie");
    //            Logger.d("---path---" + fiw);
